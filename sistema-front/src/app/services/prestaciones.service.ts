...
export class BeneficiosServices {
  ...
  public getAllBenefits(id:any): Observable<any>{
    return this.http.get(`${this.API_BENEFITS}beneficios/beneficios/${id}/`);
   }

   updateBenefits( data:any,id:any): Observable<any>{
  return this.http.put<any>(`${this.API_BENEFITS}beneficios/beneficios/${id}`, data);
   }
